...
public class CharterController : MonoBehaviour
{
    ...
    private void EnterMelleAttackState()
    {
        ...
        movement.Set(0, rb.velocity.y);
        attackDetails.damageAmount = melleAttackDamage;
        rb.velocity = movement;
        finishAttack = false;
    ...
    {
        Collider2D[] detectedObjects = Physics2D.OverlapCircleAll(melleAttackPoint.position, melleAttackRadius, whatIsPlayer);
    ...
    private void Damage(AttackDetails attackDetails)
    {
        ...
        stunCurrentHealth -= attackDetails.stunDamageAmount;
        hurtSound.Play();
        Instantiate(hitPartical, transform.position, Quaternion.Euler(0, 0, Random.Range(0, 360)));
